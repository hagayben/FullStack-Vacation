...
exports.addVacationValidator = joi_1.default.object({
    ...
    destination: joi_1.default.string().alphanum().min(4).lowercase().required(),
    description: joi_1.default.string().alphanum().min(4).lowercase().required(),
...
exports.patchVacationValidator = joi_1.default.object({
    id: joi_1.default.string().optional(),
    destination: joi_1.default.string().alphanum().min(4).lowercase(),
    description: joi_1.default.string().alphanum().min(4).lowercase(),
